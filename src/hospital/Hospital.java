...
public class Hospital {
    ...
    public Hospital() {
        Administrador administrador = new Administrador("admin1", "Mariana", "Herrejon", LocalDate.now(), "4433657403", "holamundo", "12343", 1, 18000, "marianaherrejon2@gmail.com");
...
public Paciente obtenerPacientePorId(String idPaciente){
    ...
    public boolean validarCorreoElectronico(ArrayList<? extends Usuario> listaUsuarios,String correo){
        for( Usuario usuario: listaUsuarios){
            if(usuario.getCorreoElectronico().equals(correo)){
                System.out.println("Ya existe un usuario con ese correo electronico. Intenta de nuevo");
                return false;
            }
        }
        return true;
